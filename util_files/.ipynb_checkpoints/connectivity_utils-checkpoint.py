...
def get_unique_post_types(neuron_types, count_thresh = 1, put_LC_first = True, use_broad_names = False):
    '''
    Get list of postsynaptic neuron types from neuron_types and how often they connect

    Inputs:
        neuron_types : presynaptic neuron types
    Outputs:
        post_types : numpy array of the postsynaptic neuron types sorted alphabetically
        post_types_count : number of times each postsynaptic neuron type connects
    '''
